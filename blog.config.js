...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ColorCool', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Plugins/', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.colorcool.eu.org', // 网站地址
